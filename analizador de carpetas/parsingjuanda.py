...
def parsing(file_name, extension):
    ...
    elif extension.lower() == in ['txt', 'src']:
...
def parse_with_timeout(file_name, extension, timeout_sec):
    ...
    return result
# Test
#file_path = "D:/2004/GYC 0604-0932 Torres de la Cabrera (Adicionales)_ dic/GYC 0604-0932 MURO MEDIANERO (07-12-09)/informe/Refuerzo losas.xlsx"
#file_extension = 'xlsx'
